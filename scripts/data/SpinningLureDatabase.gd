...
const PACK_ICON_BASE_PATH := "res://assets/ui/shop/spinning/packs/"
...
const RAW_LURES := [
	...
	["riverline_spin_4_gold_bee", "RiverLine Spin 4 Gold Bee", "RiverLine", "RiverLine Spin", "Вращающаяся блесна", "spinner", 4.0, 32, "золото, полосы", "Gold Bee", 3, "common", 40, 90, 1.00, "weather", 0.04, "+4% в пасмурную погоду", "окунь, голавль", "малая глубина", "RiverLine_Spin_4-Gold Bee.png"],
	...
	["riverline_spin_6_red_tail", "RiverLine Spin 6 Red Tail", "RiverLine", "RiverLine Spin", "Вращающаяся блесна", "spinner", 6.0, 38, "серебро, красный хвост", "Red Tail", 5, "common", 65, 100, 1.00, "target_fish", 0.05, "+5% по активной щуке", "окунь, щука", "средняя глубина", "RiverLine_Spin_6-Red_Tail.png"],
	...
	["riverline_spin_10_black_fury", "RiverLine Spin 10 Black Fury", "RiverLine", "RiverLine Spin", "Вращающаяся блесна", "spinner", 10.0, 46, "чёрный, яркое пятно", "Black Fury", 9, "uncommon", 115, 115, 0.90, "weather", 0.07, "+7% в ветреную погоду", "крупный окунь, щука", "средняя глубина", "RiverLine_Spin_10-Black_Fury.png"],
	...
	["lakepro_spoon_9_gold_flame", "LakePro Spoon 9 Gold Flame", "LakePro", "LakePro Spoon", "Колеблющаяся блесна", "spoon", 9.0, 50, "золото, пламя", "Gold Flame", 5, "common", 70, 115, 0.90, "weather", 0.06, "+6% в пасмурный день", "окунь, щука", "средняя глубина", "LakePro_Spoon_9-Gold_Flame.png"],
	...
	["predatorx_minnow_50_natural_fry", "PredatorX Minnow 50 Natural Fry", "PredatorX", "PredatorX Minnow", "Воблер", "wobbler", 5.0, 50, "натуральный малёк", "Natural Fry", 5, "common", 95, 120, 0.90, "target_fish", 0.05, "+5% по окуню", "окунь, мелкий хищник", "малая глубина", "PredatorX_Minnow_50-Natural_Fry.png"],
	...
	["predatorx_minnow_70_red_head", "PredatorX Minnow 70 Red Head", "PredatorX", "PredatorX Minnow", "Воблер", "wobbler", 9.0, 70, "красная голова", "Red Head", 10, "uncommon", 180, 145, 0.80, "target_fish", 0.09, "+9% по щуке", "щука", "средняя глубина", "PredatorX_Minnow_70-Red_Head.png"],
	...
	["softtail_flex_40_pearl", "SoftTail Flex 40 Pearl", "SoftTail", "SoftTail Flex", "Мягкая приманка", "soft_lure", 2.0, 40, "перламутр", "Pearl", 2, "common", 20, 70, 1.20, "target_fish", 0.03, "+3% по окуню", "окунь", "малая глубина", "SoftTail_Flex_40-Pearl.png"],
	...
	["softtail_flex_50_motoroil", "SoftTail Flex 50 MotorOil", "SoftTail", "SoftTail Flex", "Мягкая приманка", "soft_lure", 4.0, 50, "моторное масло", "MotorOil", 4, "common", 30, 78, 1.10, "water_condition", 0.05, "+5% в тёмной воде", "окунь, судак", "средняя глубина", "SoftTail_Flex_50-MotorOil.png"],
	...
	["deephunter_jig_6_pearl_fry", "DeepHunter Jig 6 Pearl Fry", "DeepHunter", "DeepHunter Jig", "Джиг", "jig", 6.0, 45, "перламутровый малёк", "Pearl Fry", 5, "common", 60, 100, 0.95, "target_fish", 0.06, "+6% по окуню на свале", "окунь, судак", "средняя глубина", "DeepHunter_Jig_6-Pearl_Fry.png"],
	...
	["surfacestrike_pop_60_red_head", "SurfaceStrike Pop 60 Red Head", "SurfaceStrike", "SurfaceStrike Pop", "Поппер", "topwater", 8.0, 60, "красная голова", "Red Head", 10, "uncommon", 200, 115, 0.82, "target_fish", 0.09, "+9% по щуке на мелководье", "щука", "поверхность", "SurfaceStrike_Pop_60-Red_Head.png"],
	...
	["surfacestrike_pop_90_trophy_frog", "SurfaceStrike Pop 90 Trophy Frog", "SurfaceStrike", "SurfaceStrike Pop", "Поппер", "topwater", 20.0, 90, "трофейная лягушка", "Trophy Frog", 19, "rare", 485, 180, 0.68, "target_fish", 0.14, "+14% по крупной щуке с поверхности", "трофейная щука", "поверхность", "SurfaceStrike_Pop_90-Trophy_Frog.png"],

	["predatorx_blade_10_white_flash", "PredatorX Blade 10 White Flash", "PredatorX", "PredatorX Blade", "Спиннербейт", "spinner_bait", 10.0, 55, "белая вспышка", "White Flash", 10, "uncommon", 205, 130, 0.80, "water_condition", 0.08, "+8% в чистой воде у травы", "щука, окунь", "малая глубина", "PredatorX_Blade_10-White_Flash.png"],
	...
	["predatorx_blade_26_trophy_black", "PredatorX Blade 26 Trophy Black", "PredatorX", "PredatorX Blade", "Спиннербейт", "spinner_bait", 26.0, 95, "трофейный чёрный", "Trophy Black", 19, "rare", 550, 200, 0.66, "target_fish", 0.14, "+14% по трофейной щуке у коряг", "трофейная щука", "средняя глубина", "PredatorX_Blade_26-Trophy_Black.png"],

	["nightglow_spin_6_moon_dot", "NightGlow Spin 6 Moon Dot", "NightGlow", "NightGlow", "Вращающаяся блесна", "spinner", 6.0, 38, "лунная точка", "Moon Dot", 14, "rare", 195, 145, 0.72, "time", 0.12, "+12% ночью", "ночной хищник, окунь", "средняя глубина", "NightGlow_Spin_6-Moon_Dot.png"],
	["nightglow_spoon_14_blue_moon", "NightGlow Spoon 14 Blue Moon", "NightGlow", "NightGlow", "Колеблющаяся блесна", "spoon", 14.0, 64, "синяя луна", "Blue Moon", 15, "rare", 255, 165, 0.70, "time", 0.13, "+13% ночью на глубине", "ночная щука, судак", "большая глубина", "NightGlow_Spoon_14-Blue_Moon.png"],
	["nightglow_minnow_80_ghost_night", "NightGlow Minnow 80 Ghost Night", "NightGlow", "NightGlow", "Воблер", "wobbler", 12.0, 80, "ночной призрак", "Ghost Night", 16, "rare", 330, 175, 0.68, "time", 0.14, "+14% ночью по судаку", "ночной судак, щука", "средняя глубина", "NightGlow_Minnow_80-Ghost_Night.png"],
	["nightglow_jig_18_purple_lamp", "NightGlow Jig 18 Purple Lamp", "NightGlow", "NightGlow", "Джиг", "jig", 18.0, 78, "фиолетовая лампа", "Purple Lamp", 17, "rare", 420, 185, 0.66, "time", 0.15, "+15% ночью у дна", "ночной судак, сом", "большая глубина", "NightGlow_Jig_18-Purple_Lamp.png"],

	["trophymax_spoon_32_king_pike", "TrophyMax Spoon 32 King Pike", "TrophyMax", "TrophyMax", "Колеблющаяся блесна", "spoon", 32.0, 95, "королевская щука", "King Pike", 20, "epic", 700, 230, 0.62, "target_fish", 0.15, "+15% по трофейной щуке", "трофейная щука", "большая глубина", "TrophyMax_Spoon_32-King_Pike.png"],
	...
	["trophymax_minnow_130_big_hunter", "TrophyMax Minnow 130 Big Hunter", "TrophyMax", "TrophyMax", "Воблер", "wobbler", 34.0, 130, "большой охотник", "Big Hunter", 26, "epic", 870, 270, 0.56, "target_fish", 0.17, "+17% по большой щуке", "самый крупный хищник", "большая глубина", "TrophyMax_Minnow_130-Big_Hunter.png"],
...
const PACK_DEFINITIONS := [
	{
		...
		"required_level": 8,
		"price": 95,
		"icon_file": "spinning_starter_lure_pack.png",
	...
	},
	{
		...
		"required_level": 8,
		"price": 240,
		"icon_file": "first_predator_lure_pack.png",
	...
	},
	{
		...
		"required_level": 10,
		"price": 590,
		"icon_file": "grass_pike_lure_pack.png",
	...
	},
	{
		...
		"required_level": 14,
		"price": 990,
		"icon_file": "night_hunt_lure_pack.png",
	...
	},
	{
		...
		"required_level": 20,
		"price": 2200,
		"icon_file": "trophy_pike_lure_pack.png",
...
static func get_lure_packs() -> Array:
	...
	for pack_def in PACK_DEFINITIONS:
		...
		var icon_file := str(pack_def.get("icon_file", ""))
		var icon_path := PACK_ICON_BASE_PATH + icon_file if icon_file != "" else ""
