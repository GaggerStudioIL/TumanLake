...
- инвентарь;
- магазин;
- наборы спиннинговых приманок в магазине;
- катушки в магазине и прогрессии;
- спиннинговые удилища в магазине и прогрессии;
- автоудаление полностью сломанной неремонтируемой снасти;
- карта водоёмов;
- системное меню;
...
- scripts/data/SpinningLureDatabase.gd — база спиннинговых приманок и наборов.
- scripts/data/ReelDatabase.gd — база катушек.
- scripts/data/SpinningRodDatabase.gd — база спиннинговых удилищ.
...
12. Debug panel не видна, spinning test mode выключен, спиннинговые предметы открываются только через прогрессию.
13. Если готовится тестерский билд, APK/AAB собран из актуальной ветки. Для контентных коммитов без сборки этот пункт пропускается.
